...
/**  
 * ERROR WAS: caught TypeError: Student is not a constructor
 *  at app.js:176:11
 *  (
*/
console.log(joe);
...
//    - When joe.scope() is invoked, the "this" refers to all the properties associated with "Joe"
// 2. What is "this" when joe.scopeArrow() is invoked?
//    - when the joe.scopeArrow() is invoked, the "this" refers to all the window properties.
// 3. Explain why "this" is different when an arrow function is used.
//    - According to MDN,  arrow functions dont have their own 'this' and should only be used with non-method functions.
